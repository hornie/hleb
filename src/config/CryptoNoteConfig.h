...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(120000000000000);
...
#ifdef _WIN32
#pragma warning(disable:4244) //silence C4244 conversion warning
#endif
...
const uint32_t UPGRADE_HEIGHT_V5                             = 4; // Upgrade height for CN Variant 2 switch.
