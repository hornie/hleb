...
Open the wallets with hleb-serivce like so:

./hleb-service -w walletA.wallet -p yourpass --rpc-password test --bind-port 8070
./hleb-service -w walletB.wallet -p yourpass --rpc-password test --bind-port 8071
