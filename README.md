HLEBCoin, the coin no one ever asked for, but it exists nonetheless.

### Installing

We offer binary images of the latest releases here: http://latest.hleb.cc
...
- `export CC=gcc-8`
- `export CXX=g++-8`
- `git clone -b master --single-branch https://github.com/hornie/hleb`
- `cd hleb`
- `mkdir build`
- `cd build`
- `cmake ..`
...
- `MSBuild HLEBCoin.sln /p:Configuration=Release /m`
